...
class FrameProfiler {
   public:
    ...
    explicit FrameProfiler(const rclcpp::Node::SharedPtr& node, const std::string& topic, double warn_ms,
                           double error_ms, int consecutive_threshold)
     ...
     */
    static std::string formatSummary(double pt_ms, double seg_ms, double cluster_ms, double total_ms,
                                     int no_data_frames);
