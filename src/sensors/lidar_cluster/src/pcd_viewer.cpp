...
int main() {
    ...
    viewer->addText(std::format("before VoxelGridFiltering        number of points: {}", source->points.size()),
                    10, 10, 20, 150, 150, 150, "v1 text", v1);
    ...
    viewer->addText(std::format("after VoxelGridFiltering        number of points: {}", source2->points.size()),
                    10, 10, 20, 150, 150, 150, "v2 text", v2);
