...
UrinayParams::UrinayParams(rclcpp::Node* const nh) {
    ...
    main = Main{.input_cones_topic = declare_and_get("input_cones_topic", std::string("/sensors/cones/fused")),
    ...
    wayComputer = WayComputer{
        ...
        .search = {.max_way_horizon_size = declare_and_get("max_way_horizon_size", 0),
        ...
        .way = {.max_dist_loop_closure = declare_and_get("max_dist_loop_closure", 1.0),
    ...
    visualization = Visualization{
        ...
        .triangulation_topic =
            declare_and_get("marker_topics.triangulation", std::string("/visualization/urinay/triangulation")),
