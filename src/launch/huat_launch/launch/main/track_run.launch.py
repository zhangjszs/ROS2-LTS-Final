# /**
#  * \file track_run.launch.py
#  * \brief Track run: sensor stack + track planner (urinay) + control + safety + visualization
#  *
#  * Converts track_run.launch (ROS1) to ROS2 Python launch file.
#  *
#  * Usage:
#  *   ros2 launch huat_launch track_run.launch.py
#  */
#
...
def generate_launch_description():
    ...
    rviz_arg = DeclareLaunchArgument(
        'rviz',
        default_value='true',
        description='Launch RViz with tuxiang.rviz',
    )
    ...
    track_planner_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'output_topic': LaunchConfiguration('path_topic'),
            'stop_topic': LaunchConfiguration('stop_request_topic'),
        }.items(),
    )
