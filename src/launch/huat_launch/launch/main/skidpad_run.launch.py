# /**
#  * \file skidpad_run.launch.py
#  * \brief Skidpad run: sensor stack + skidpad planner + control + safety + visualization
#  *
#  * Converts skidpad_run.launch (ROS1) to ROS2 Python launch file.
#  *
#  * Usage:
#  *   ros2 launch huat_launch skidpad_run.launch.py
#  */
#
...
def generate_launch_description():
    ...
    # Skidpad planner
    skidpad_planner_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(
                get_package_share_directory('huat_launch'),
                'launch',
