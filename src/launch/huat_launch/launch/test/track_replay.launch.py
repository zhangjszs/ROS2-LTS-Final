# /**
#  * \file track_replay.launch.py
#  * \brief Track replay: track_run.launch + rosbag playback
#  *
#  * Converts track_replay.launch (ROS1) to ROS2 Python launch file.
#  *
#  * Vehicle commands are remapped to debug topic to prevent accidental vehicle movement.
#  *
#  * Usage:
#  *   ros2 launch huat_launch track_replay.launch.py
#  *   ros2 launch huat_launch track_replay.launch.py bag:=/path/to.bag
#  */
#
...
# distributed under the License is distributed on an "AS0" BASIS,
...
def generate_launch_description():
    ...
    # Track run launch (with velodyne driver disabled)
